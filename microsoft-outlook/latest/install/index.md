...
3. From a command line, navigate to the `x64` or `x86` directory, and run the `msiexec` command. For example:
    ...
    |`LANGS`|No default|Sets the available languages for the Alfresco Outlook Client. Format: `"en,de,fr"`. See CULTURE parameter for available language codes. Added in Outlook Integration 2.9.|
