...
2. Configure the attributes that you need for the base `<outlook>` element:
    ...
    |`showSpecificLanguages`|Sets the available languages of the Outlook plugin.<br><br>Added in Outlook Integration 2.9.|`empty`: All supported languages can be selected. This is the default setting.<br><br>`en,de,fr`(example): Only English, German and French can be selected.|
